...
//  TDGame
//
//  Created by Dmitry Kozlov on 14.10.12.
...
{
    self = [super initWithName:@"Missile" atX:x andY:y andDirection:0.0f andFly:YES andSpeed:7.0f onField:(TDField *)field];
    if (self) {
        self.target = target;
        self.speed = speed;
        self.damage = damage;
